...
HD_PWD='/home/rehan/MERL/FPGA_EMU/4_bit_ripple_adder/4_bit_ripple_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_ripple_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source four_bit_ripple_adder.tcl
